...
public class TesteAbrirFilePassword {
    ...
    public static boolean testaSenha(String senha, int numArquivos) {
        //necessário trocar o nome do arquivo de maneira iterativa

        ZipFile zipFile = new ZipFile(new File(caminho + "doc" + numArquivos + ".zip"));
        try {
    ...
    public static boolean generatePassword(int numbChar, int arquivo) {
        String senha = "";
